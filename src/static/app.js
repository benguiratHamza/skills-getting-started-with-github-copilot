      ...
      Object.entries(activities).forEach(([name, details]) => {
        ...
        const participantsItems = details.participants.length
          ? details.participants
              .map(
                (participant) =>
                  `<li><span class="participant-name">${participant}</span><button class="participant-delete" data-activity="${name}" data-email="${participant}" aria-label="Remove ${participant}">×</button></li>`
              )
              .join("")
